...
class AuthSession extends Model
{
     ...
     */
    public static function createForPhone(string $phone, ?string $name = null): self
    {
        ...
        if ($existingSession) {
            ...
            if ($name !== null) {
                $existingSession->update(['name' => $name]);
            }
        ...
        return self::create([
            ...
            'is_verified' => false,
            'expires_at' => now()->addHours(24), // Session valid for 24 hours
        ]);
    }
}
